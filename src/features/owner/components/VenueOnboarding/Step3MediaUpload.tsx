...
export default function Step3MediaUpload({
  ...
  return (
    <main className="flex-grow pt-6 pb-24 px-6 container mx-auto max-w-4xl">
      {venueId ? (
        <div className="flex justify-normal text-primary">
          VenueId: {venueId}
        </div>
      ) : (
        <>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3 mb-8">
        ...
        <p className="text-gray-800">
          ...
          . Upload clear images of your courts, amenities, and entrance to help
          athletes feel confident in their choice.
        </p>
      </div>
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <Upload
                    size={48}
                    className="text-gray-400 group-hover:scale-110 transition-transform duration-200 mb-3"
                  />
                  ...
                  <p className="mt-2 text-xs text-gray-600">
                    Max 5 images per court (PNG, JPG up to 5MB)
                  </p>
                </div>
              </div>
